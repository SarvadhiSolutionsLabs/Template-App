...
internal enum Asset {
  ...
  internal static let baseBackground = ColorAsset(name: "Base Background")
  internal static let errorColor = ColorAsset(name: "ErrorColor")
  internal static let fillButtonColor = ColorAsset(name: "FillButtonColor")
  internal static let infoColor = ColorAsset(name: "InfoColor")
  internal static let mainTextColor = ColorAsset(name: "MainTextColor")
  internal static let outlineColor = ColorAsset(name: "OutlineColor")
  ...
  internal static let softBlueColor = ColorAsset(name: "SoftBlueColor")
  ...
  internal static let formColor = ColorAsset(name: "formColor")
  ...
  internal static let icBlackClose = ImageAsset(name: "ic_black_close")
  internal static let icSearchClose = ImageAsset(name: "ic_search_close")
}
